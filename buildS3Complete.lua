...
-- Delete old ROM.
os.remove("sonic3k.prev.bin")

-- Backup the most recent ROM.
os.rename("sonic3k.bin", "sonic3k.prev.bin")

-- Assemble the ROM.
local assemble_result = common.assemble_file("sonic3k.asm", "sonic3k.bin", tools.as, "", tools.s1p2bin, improved_dac_driver_compression and "" or " -a", false)
...
elseif assemble_result == "error" then
	for line in io.lines("sonic3k.log") do
		print(line)
	end
